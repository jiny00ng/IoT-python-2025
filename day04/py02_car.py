...
class Car:
    ...
    ## company, name, plateNumber 모를때는 None(뭔지 몰라)
...
#모듈화 하려면 예제 소스를 없어야 함
# myCar = Car('현대차', '아이오닉', '54라9537')
# 파리미터 명 = 값으로 매개변수 순서를 변경가능
# myCar = Car(name='아이오닉', plateNumber='54라9537', company='현대차')
# print(myCar) # 차의 번호를 출력하고 싶음
# myCar.__plateNumber = 2011 # 클래스 외부에서 잘못된 데이터를 넣어도 문제가 발생X
# print(myCar)
# myCar.setPlateNumber('54라')
# print(myCar)
